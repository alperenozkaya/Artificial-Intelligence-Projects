...
class GameController:
    ...
    def __init__(self):
        ...
        self.time_flag_10 = True # to check whether the running time is already printed
        self.time_flag_25 = True  # to check whether the running time is already printed
        self.time_flag_34 = True  # to check whether the running time is already printed
    ...
    def get_score(self):
         # check for running times
        if self.snake:
            if self.snake.score == 10 and self.time_flag_10:  # added
                print("running time until score 10: " + str(time.time() - self.algorithm_time))  # added
                self.time_flag_10 = False
            elif self.snake.score == 25 and self.time_flag_25:
                print("running time until score 25: " + str(time.time() - self.algorithm_time))  # added
                self.time_flag_25 = False

            elif self.snake.score == 34 and self.time_flag_34:
                print("running time until score 34: " + str(time.time() - self.algorithm_time))  # added
                self.time_flag_34 = False
            else:
                pass
    ...
    def set_algorithm(self, algo_type):
        ...
        if algo_type == 'BFS':
            ...
            print('**** BFS ****')
            print('')
            self.algorithm_time = time.time() # time when the game starts
            self.snake = Snake()
